...
{
    cout << "\n______________Round [" << RoundInfo.RoundNumber << "]________________\n\n";
...
stGameResults FillGameResult(int GameRound, short Player1WinTimes, short ComputerWinTimes, short DrawTimes)
{
...
stGameResults PlayGame(short HowManyRounds)
{
    ...
    for (short GameRounds = 1; GameRounds <= HowManyRounds; GameRounds++)
    {
        ...
        if (RoundInfo.Winner == enWinner::Player1)
            ...
            ComputerWinTimes++;
        else(RoundInfo.Winner == enWinner::Draw);
...
{
    cout << Tabs(2) << "__________________________________________________________________________\n\n";
...
{
    cout << Tabs(2) << "_______________________________ [Game Results] ____________________________\n\n";
